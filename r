...
function Update:Window(text,logo,keybind)
	...
	Hub.Text = " HUB"
	Hub.TextColor3 = Color3.fromRGB(7, 236, 240)
	Hub.TextSize = 17.000
		...
		spawn(function()
            while wait() do
                pcall(function()
                    wait(0.1) 
                    game:GetService('TweenService'):Create(
                        TabButton,TweenInfo.new(1,Enum.EasingStyle.Linear,Enum.EasingDirection.InOut),
                        {TextColor3 = Color3.fromRGB(255, 0, 0)}
                    ):Play() 
                    wait(.5)            
                    game:GetService('TweenService'):Create(
		...
		function main:AddButton(text,callback)
            ...
            while wait() do
                pcall(function()
                    wait(0.1) 
                    game:GetService('TweenService'):Create(
                        TextBtn,TweenInfo.new(1,Enum.EasingStyle.Linear,Enum.EasingDirection.InOut),
                        {TextColor3 = Color3.fromRGB(255, 0, 0)}
                    ):Play() 
                    wait(.5)            
                    game:GetService('TweenService'):Create(
		...
		function main:AddToggle(text,config,callback)
            ...
            while wait() do
                pcall(function()
                    wait(0.1) 
                    game:GetService('TweenService'):Create(
                        Label,TweenInfo.new(1,Enum.EasingStyle.Linear,Enum.EasingDirection.InOut),
                        {TextColor3 = Color3.fromRGB(255, 0, 0)}
                    ):Play() 
                    wait(.5)            
                    game:GetService('TweenService'):Create(
	    ...
	    spawn(function()
            while wait() do
                pcall(function()
                    wait(0.1) 
                    game:GetService('TweenService'):Create(
                        tggc,TweenInfo.new(1,Enum.EasingStyle.Linear,Enum.EasingDirection.InOut),
                        {TextColor3 = Color3.fromRGB(255, 0, 0)}
                    ):Play() 
                    wait(.5)            
                    game:GetService('TweenService'):Create(
		...
		function main:AddDropdown(text,option,callback)
            ...
            while wait() do
                pcall(function()
                    wait(0.1) 
                    game:GetService('TweenService'):Create(
                        DropTitle,TweenInfo.new(1,Enum.EasingStyle.Linear,Enum.EasingDirection.InOut),
                        {TextColor3 = Color3.fromRGB(255, 0, 0)}
                    ):Play() 
                    wait(.5)            
                    game:GetService('TweenService'):Create(
		...
		spawn(function()
            while wait() do
                pcall(function()
                    wait(0.1) 
                    game:GetService('TweenService'):Create(
                        Item,TweenInfo.new(1,Enum.EasingStyle.Linear,Enum.EasingDirection.InOut),
                        {TextColor3 = Color3.fromRGB(255, 0, 0)}
                    ):Play() 
                    wait(.5)            
                    game:GetService('TweenService'):Create(
		...
		function main:AddSlider(text,min,max,set,callback)
            ...
            while wait() do
                pcall(function()
                    wait(0.1) 
                    game:GetService('TweenService'):Create(
                        SliderLabel,TweenInfo.new(1,Enum.EasingStyle.Linear,Enum.EasingDirection.InOut),
                        {TextColor3 = Color3.fromRGB(255, 0, 0)}
                    ):Play() 
                    wait(.5)            
                    game:GetService('TweenService'):Create(
		...
		function main:AddTextbox(text,disappear,callback)
            ...
            while wait() do
                pcall(function()
                    wait(0.1) 
                    game:GetService('TweenService'):Create(
                        TextboxLabel,TweenInfo.new(1,Enum.EasingStyle.Linear,Enum.EasingDirection.InOut),
                        {TextColor3 = Color3.fromRGB(255, 0, 0)}
                    ):Play() 
                    wait(.5)            
                    game:GetService('TweenService'):Create(
		...
		function main:AddSeperator(text)
            ...
            while wait() do
                pcall(function()
                    wait(0.1) 
                    game:GetService('TweenService'):Create(
                        Sep2,TweenInfo.new(1,Enum.EasingStyle.Linear,Enum.EasingDirection.InOut),
                        {TextColor3 = Color3.fromRGB(255, 0, 0)}
                    ):Play() 
                    wait(.5)            
                    game:GetService('TweenService'):Create(
...
local Library = Update:Window("Codex ","Ver : RgbTex",Enum.KeyCode.RightControl);
...
local TES = Library:AddTab("Nothing Here","")
...
H:AddLabel("Bem Vindo Ao HygorL Hub")

H:AddSeperator("Credit")


H:AddButton("clique aqui e cole",function()
setclipboard("hygorl lindo")
end)

H:AddButton("Discord ScriptersGold",function()
setclipboard("discord.gg/scriptersgold")
end)
...
Main:AddToggle("Trun Off Bypass tp",false,function(Fast)
BypassTP = Fast
end)
...
elseif _G.WhiteScreen == false then
    ...
    PosY = 35
    Main:AddSlider("Pos Y",0,50,35,function(value)
    PosY = value
    end)

    PosZ = 25
    Main:AddSlider("Pos Z",0,50,25,function(value)
    PosZ = value
    end)
...
TES:AddLabel("ทําไว้เพือให้ Tab Misc โผล่ขึ้นมา")
...
game.StarterGui:SetCore("SendNotification", {
      Icon = "http://www.roblox.com/asset/?id=12523036534";
      Title = "Hysoal Hub Free", 
      Text = "Bem vindo! Aproveite nosso script";
})
wait(3)
game.StarterGui:SetCore("SendNotification", {
      Icon = "http://www.roblox.com/asset/?id=12523036534";
      Title = "HygorL Hub", 
      Text = "Feito por HygorL e HashishX";
})
